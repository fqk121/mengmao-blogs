    ...
    <el-container class="me-allct-container">
      <el-main>
        <el-tabs v-model="activeName">
          <el-tab-pane label="文章分类" name="category" class="fenye">
              ...
              >
                <div class="me-allct-content">
                  ...
                  <div class="me-allct-meta">
                    <span>{{ c.articles }} 文章分类</span>
                  </div>
                </div>
              </li>
            </ul>
          </el-tab-pane>
          <el-tab-pane label="标签" name="tag" text-color="aliceblue">
            <ul class="me-allct-items">
              <li
                v-for="t in tags"
                @click="view(t.id)"
...
<script>
import defaultAvatar from "@/assets/img/logo1.png";
